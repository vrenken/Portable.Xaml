...
namespace MonoTests.Portable.Xaml.Json
{
	...
	public class JsonWriterTests
	{
		...
		public void Write_TestClass4_WithNull()
		{
			...
			var json = XamlJsonServices.Save(instance);
			var expected = @"{""$ns"":""clr-namespace:MonoTests.Portable.Xaml;assembly=Portable.Xaml_test_core"",""$ns:x"":""http://schemas.microsoft.com/winfx/2006/xaml"",""$type"":""TestClass4"",""Bar"":null,""Foo"":""bar""}";
			Assert.AreEqual(expected.UpdateJson(), json);
		}
