...
namespace Portable.Xaml.Json
{
	class XamlJsonWriterInternal : XamlWriterInternalBase
	{
		...
		public XamlJsonWriterInternal(XamlJsonWriterSettings settings, TextWriter writer, XamlSchemaContext schemaContext, XamlWriterStateManager manager)
	...
	[EnhancedXaml]
	public class XamlJsonWriter : XamlWriter
	{
		...
		public XamlJsonWriter(TextWriter writer, XamlSchemaContext schemaContext, XamlJsonWriterSettings settings)
		{
			...
			_intl = new XamlJsonWriterInternal(_settings, _writer, _schemaContext, manager);
		}
